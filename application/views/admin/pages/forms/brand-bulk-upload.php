                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/brand/process_bulk_upload'); ?>" method="POST" id="bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="card-body pad">
                                        <div class="form-group">
                                            <a href="<?= base_url('uploads/brand-bulk-upload-sample.csv') ?>" class="btn btn-info" download="brand-bulk-upload-sample.csv">Bulk upload sample file <i class="fas fa-download"></i></a>

                                            <a href="<?= base_url('uploads/brand-bulk-update-sample.csv') ?>" class="btn btn-info" download="brand-bulk-update-sample.csv">Bulk update sample file <i class="fas fa-download"></i></a>
