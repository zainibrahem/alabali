...
class Custom_notification_model extends CI_Model
{
    ...
    public function get_custom_notifications_data($offset = 0, $limit = 10, $sort = 'id', $order = 'ASC')
    {
        ...
        foreach ($city_search_res as $row) {
            ...
            $operate = ' <a class="delete_custom_notification btn btn-danger btn-xs mr-1 mb-1" title="Delete" href="javascript:void(0)"  data-id="' . $row['id'] . '" ><i class="fa fa-trash"></i></a>';
            $operate .= '<a href="javascript:void(0)" class="edit_btn btn btn-primary btn-xs mr-1 mb-1" data-id="' . $row['id'] . '" data-url="admin/custom_notification" title="View Order" ><i class="fa fa-pen"></i></a>';
